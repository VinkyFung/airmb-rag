...
const faqs: FaqItem[] = [
  { id: 1, knowledgeId: 'FAQ-ACCOUNT-001', categoryL1: '平台服务', categoryL2: '账户管理', businessType: '账户', question: '如何修改绑定手机号？', paraphrases: ['手机号怎么换', '原手机号不用了怎么办', '在哪里改手机号'], answer: '进入「我的-设置-账号与安全-手机号」，完成原手机号验证后可绑定新手机号。若原手机号已无法使用，请联系人工客服进行身份核验。', risk: '中', authRequired: true, autoAnswer: true, status: '已发布', embeddingStatus: '已生成', updatedAt: '2026-07-05 16:24', updatedBy: '客服运营', version: 3 },
  { id: 2, knowledgeId: 'FAQ-TRADE-018', categoryL1: '交易服务', categoryL2: '订单管理', businessType: '订单', question: '拍下商品后多久需要付款？', paraphrases: ['订单付款时效', '下单后可以多久再付钱'], answer: '订单提交后请在 30 分钟内完成付款，超时未付款订单将自动关闭。具体倒计时以订单详情页展示为准。', risk: '低', authRequired: false, autoAnswer: true, status: '已发布', embeddingStatus: '未生成', updatedAt: '2026-07-05 14:08', updatedBy: '李明', version: 5 },
  { id: 3, knowledgeId: 'FAQ-WALLET-006', categoryL1: '资金服务', categoryL2: '钱包提现', businessType: '钱包', question: '提现后多久到账？', paraphrases: ['提现一直没到账', '钱包提现时效'], answer: '提现申请审核通过后，通常在 1–3 个工作日内到账。实际到账时间受银行处理进度影响。', risk: '高', authRequired: true, autoAnswer: false, status: '已发布', embeddingStatus: '生成失败', embeddingError: 'mock：向量服务暂不可用', updatedAt: '2026-07-04 18:42', updatedBy: '王琪', version: 2 },
  { id: 4, knowledgeId: 'FAQ-AFTERSALE-012', categoryL1: '交易服务', categoryL2: '售后服务', businessType: '售后', question: '收到的商品与描述不符怎么办？', paraphrases: ['实物和图片不一样', '卖家描述不符怎么退'], answer: '请在确认收货前发起售后申请，选择“商品与描述不符”，并上传清晰的商品照片及相关凭证。平台将在材料提交后介入核实。', risk: '中', authRequired: true, autoAnswer: true, status: '草稿', embeddingStatus: '未生成', updatedAt: '2026-07-04 10:16', updatedBy: '陈晨', version: 1 },
  { id: 5, knowledgeId: 'FAQ-PUBLISH-009', categoryL1: '平台服务', categoryL2: '商品发布', businessType: '发布', question: '如何发布一件藏品？', paraphrases: ['怎么卖藏品', '发布商品入口在哪'], answer: '点击首页底部“发布”，按页面提示填写藏品名称、分类、品相和价格，并上传清晰图片后提交审核。', risk: '低', authRequired: true, autoAnswer: true, status: '已发布', embeddingStatus: '已生成', updatedAt: '2026-07-03 09:31', updatedBy: '客服运营', version: 4 },
  { id: 6, knowledgeId: 'FAQ-ACCOUNT-014', categoryL1: '平台服务', categoryL2: '实名认证', businessType: '账户', question: '实名认证可以修改吗？', paraphrases: ['怎么换实名', '实名信息填错了'], answer: '实名认证信息涉及账户安全，暂不支持用户自行修改。如确需变更，请联系人工客服并按要求提交证明材料。', risk: '高', authRequired: true, autoAnswer: false, status: '已停用', embeddingStatus: '未生成', updatedAt: '2026-07-02 15:20', updatedBy: '管理员', version: 2 },
]
